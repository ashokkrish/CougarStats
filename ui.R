  ...
  ui <- fluidPage(
    ...
    navbarPage(
      title = div(img(src ="CougarStats.png", height = 100), 
                  span("CougarStats", 
                       style = "color:#000000; font-weight:bold; font-style: italic; font-size:24pt")),
                      ...
                      tabPanel(
                        ...
                        conditionalPanel(
                          ...
                          dropdown(
                            ...
                            colourpicker::colourInput(
                              inputId = "slrRegLineColour", 
                              label = strong("Regression Line Colour"), 
                              value = "#819BB6"
                            ),
                                                                               
                            colourpicker::colourInput(
                              inputId = "slrScatterColour", 
